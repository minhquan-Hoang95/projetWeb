 ...
 */
final class Version20250324181002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__l3_users AS SELECT id, login, roles, password, firstname, lastname, birthdate FROM l3_users');
        ...
        , password VARCHAR(255) NOT NULL, firstname VARCHAR(200) NOT NULL, lastname VARCHAR(200) NOT NULL, birthdate DATETIME DEFAULT NULL, CONSTRAINT FK_54943D84A6E44244 FOREIGN KEY (pays_id) REFERENCES l3_pays (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO l3_users (id, login, roles, password, firstname, lastname, birthdate) SELECT id, login, roles, password, firstname, lastname, birthdate FROM __temp__l3_users');
